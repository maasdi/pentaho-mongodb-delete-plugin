...
=======================
[![Build Status](https://travis-ci.org/maasdi/pentaho-mongodb-delete-plugin.svg?branch=2.0.0)](https://travis-ci.org/maasdi/pentaho-mongodb-delete-plugin/builds)
