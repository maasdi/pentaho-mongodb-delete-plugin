...
public class MongoDbDeleteMetaTest {
    ...
    public void testRoundTrips() throws KettleException {
        ...
        validatorFactory.registerValidator(validatorFactory.getName(List.class, MongoDbDeleteMeta.MongoField.class),
                new ListLoadSaveValidator<MongoDbDeleteMeta.MongoField>(new ObjectValidator<MongoDbDeleteMeta.MongoField>(validatorFactory, MongoDbDeleteMeta.MongoField.class,
